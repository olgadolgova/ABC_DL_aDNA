...
String[] names = {"ModernGreek", "Logkas", "Manika", "Anatolian_N", "Yamnaya", "Steppe_introgressedLogkas", "Steppe_introgressedAegean", "CHG", "CHG_introgressed", "EHG", "EHG_introgressed", "EHG_introgressedAegean"};
// Add the populations
...
// Ancient populations 
        ...
        demography.addSample ("CHG_introgressed", 0); // CHG introgressed into GreeceBA
        demography.addSample ("Steppe_introgressedLogkas", 0); // Steppe introgressed into Aegean MBA
        demography.addSample ("Steppe_introgressedAegean", 0); // Steppe introgressed into Aegean BA
        demography.addSample ("EHG_introgressedAegean", 0); // EHG introgressed into Crete 
...
// Split EHGs introgressed from EHG Sidelkino
        NeallSteppes = new ParameterValue("NeAllSteppe", new DistributionUniformFromValue(new Value(1000), new Value(20000)));
        ...
        tSplitSteppe_introgressedAegean.setScalable(tSplitSteppe_introgressedAegean);
...
// Introgression Steppe into Aegean before the Aegean BA split   
        ...
        ParameterValue introgression_Steppe_AegeanBA = new ParameterValue("introgression_Steppe_BAAegeans", new DistributionUniformFromValue(new Value(0.001), new Value(0.8)));
        parameters.add(introgression_Steppe_AegeanBA);
        EventParameter eIntrogression_Steppe_AegeanBA = new EventParameter(ptIntrogression_Steppe_AegeanBA, demography.getPosition("Manika"), demography.getPosition("Steppe_introgressedAegean"), introgression_Steppe_AegeanBA, new Value(1.0), new Value(1.0), new Value(0), 1);
        demography.add_event(eIntrogression_Steppe_AegeanBA);
